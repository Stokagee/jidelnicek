...
| AC-5 | Create/edit dish (§14.5) | T-5.4 → T-5.3 | `api/dishes.test.ts`, `api/weeks.test.ts`, `domain/dishBlock.test.ts` (green) | `acceptance/suites/fe_ep4_dishes_ui.robot` | tests written, `notready` (screen in T-5.3) |
